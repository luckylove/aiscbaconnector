...
public class CBA_REQUEST {
    ...
    public Date getCbRequestTime() {
        return cbRequestTime;
    }

    public void setCbRequestTime(Date cbRequestTime) {
        this.cbRequestTime = cbRequestTime;
    }
    ...
    public String getAgentVdn() {
        return agentVdn;
    }

    public void setAgentVdn(String agentVdn) {
